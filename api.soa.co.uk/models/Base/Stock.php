...
abstract class Stock implements ActiveRecordInterface
{
    ...
    /**
     * The value for the stockid field.
     * @var        int
     */
    protected $stockid;
    ...
    /**
     * The value for the retailprice field.
     * @var        string
     */
    ...
    /**
     * Get the [retailprice] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [stockid] column.
     *
    ...
    public function setStockid($v)
    {
        ...
        if ($this->stockid !== $v) {
            $this->stockid = $v;
            $this->modifiedColumns[StockTableMap::COL_STOCKID] = true;
        }
    ...
    public function setProductid($v)
    {
        ...
        if ($this->productid !== $v) {
            $this->productid = $v;
            $this->modifiedColumns[StockTableMap::COL_PRODUCTID] = true;
        }
    ...
    /**
     * Set the value of [retailprice] column.
     *
    ...
    public function setRetailprice($v)
    {
        ...
        if ($this->retailprice !== $v) {
            $this->retailprice = $v;
            $this->modifiedColumns[StockTableMap::COL_RETAILPRICE] = true;
        }
    ...
    public function setQuanitity($v)
    {
        ...
        if ($this->quanitity !== $v) {
            $this->quanitity = $v;
            $this->modifiedColumns[StockTableMap::COL_QUANITITY] = true;
        }
    ...
    public function setVendingmachineid($v)
    {
        ...
        if ($this->vendingmachineid !== $v) {
            ...
            $this->modifiedColumns[StockTableMap::COL_VENDINGMACHINEID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StockTableMap::translateFieldName('Stockid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->stockid = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StockTableMap::translateFieldName('Retailprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->retailprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : StockTableMap::translateFieldName('Quanitity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quanitity = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : StockTableMap::translateFieldName('Vendingmachineid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = StockTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null !== $this->stockid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . StockTableMap::COL_STOCKID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(StockTableMap::COL_STOCKID)) {
            $modifiedColumns[':p' . $index++]  = 'StockID';
        }
        if ($this->isColumnModified(StockTableMap::COL_PRODUCTID)) {
            $modifiedColumns[':p' . $index++]  = 'ProductID';
        }
        if ($this->isColumnModified(StockTableMap::COL_RETAILPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'RetailPrice';
        }
        if ($this->isColumnModified(StockTableMap::COL_QUANITITY)) {
            $modifiedColumns[':p' . $index++]  = 'Quanitity';
        }
        if ($this->isColumnModified(StockTableMap::COL_VENDINGMACHINEID)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'StockID':
                        $stmt->bindValue($identifier, $this->stockid, PDO::PARAM_INT);
                        break;
                    case 'ProductID':
                        $stmt->bindValue($identifier, $this->productid, PDO::PARAM_INT);
                        break;
                    case 'RetailPrice':
                        $stmt->bindValue($identifier, $this->retailprice, PDO::PARAM_STR);
                        break;
                    case 'Quanitity':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getStockid(),
            $keys[1] => $this->getProductid(),
            $keys[2] => $this->getRetailprice(),
            $keys[3] => $this->getQuanitity(),
            $keys[4] => $this->getVendingmachineid(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setStockid($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setProductid($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setRetailprice($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setQuanitity($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setVendingmachineid($arr[$keys[4]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StockTableMap::COL_STOCKID)) {
            $criteria->add(StockTableMap::COL_STOCKID, $this->stockid);
        }
        if ($this->isColumnModified(StockTableMap::COL_PRODUCTID)) {
            $criteria->add(StockTableMap::COL_PRODUCTID, $this->productid);
        }
        if ($this->isColumnModified(StockTableMap::COL_RETAILPRICE)) {
            $criteria->add(StockTableMap::COL_RETAILPRICE, $this->retailprice);
        }
        if ($this->isColumnModified(StockTableMap::COL_QUANITITY)) {
            $criteria->add(StockTableMap::COL_QUANITITY, $this->quanitity);
        }
        if ($this->isColumnModified(StockTableMap::COL_VENDINGMACHINEID)) {
            $criteria->add(StockTableMap::COL_VENDINGMACHINEID, $this->vendingmachineid);
        }
    ...
    /**
     * Generic method to set the primary key (stockid column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setRetailprice($this->getRetailprice());
        $copyObj->setQuanitity($this->getQuanitity());
        $copyObj->setVendingmachineid($this->getVendingmachineid());
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setStockid(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    public function getVendingmachine(ConnectionInterface $con = null)
    {
        if ($this->aVendingmachine === null && ($this->vendingmachineid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVendingmachine->addStocks($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aVendingmachine) {
            $this->aVendingmachine->removeStock($this);
        }
        $this->stockid = null;
        $this->productid = null;
