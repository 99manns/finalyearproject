 ...
 *
 *
 * @method     ChildGenderQuery orderByGenderid($order = Criteria::ASC) Order by the GenderID column
 * @method     ChildGenderQuery orderByName($order = Criteria::ASC) Order by the Name column
 *
 * @method     ChildGenderQuery groupByGenderid() Group by the GenderID column
 ...
 *
 * @method     ChildGenderQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method     ChildGenderQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method     ChildGenderQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 * @method     ChildGenderQuery joinWithUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the User relation
 *
 * @method     ChildGenderQuery leftJoinWithUser() Adds a LEFT JOIN clause and with to the query using the User relation
 * @method     ChildGenderQuery rightJoinWithUser() Adds a RIGHT JOIN clause and with to the query using the User relation
 * @method     ChildGenderQuery innerJoinWithUser() Adds a INNER JOIN clause and with to the query using the User relation
 *
 ...
 *
 * @method     ChildGender findOneByGenderid(int $GenderID) Return the first ChildGender filtered by the GenderID column
 ...
 *
 * @method     ChildGender requireOneByGenderid(int $GenderID) Return the first ChildGender filtered by the GenderID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildGender[]|ObjectCollection findByGenderid(int $GenderID) Return ChildGender objects filtered by the GenderID column
...
abstract class GenderQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\GenderQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gender', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = GenderTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT GenderID, Name FROM gender WHERE GenderID = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = new ChildGender();
            $obj->hydrate($row);
            GenderTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(GenderTableMap::COL_GENDERID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(GenderTableMap::COL_GENDERID, $keys, Criteria::IN);
    }
    ...
    public function filterByGenderid($genderid = null, $comparison = null)
    {
        if (is_array($genderid)) {
            ...
            if (isset($genderid['min'])) {
                $this->addUsingAlias(GenderTableMap::COL_GENDERID, $genderid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($genderid['max'])) {
                $this->addUsingAlias(GenderTableMap::COL_GENDERID, $genderid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GenderTableMap::COL_GENDERID, $genderid, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \User) {
            return $this
                ->addUsingAlias(GenderTableMap::COL_GENDERID, $user->getGenderid(), $comparison);
    ...
    {
        if ($gender) {
            $this->addUsingAlias(GenderTableMap::COL_GENDERID, $gender->getGenderid(), Criteria::NOT_EQUAL);
        }
