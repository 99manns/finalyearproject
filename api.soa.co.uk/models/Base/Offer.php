...
abstract class Offer implements ActiveRecordInterface
{
    ...
    /**
     * The value for the quanitity field.
     * @var        int
     */
    protected $quanitity;
    ...
    /**
     * Get the [quanitity] column value.
     *
     * @return int
     */
    ...
    public function setOfferid($v)
    {
        ...
        if ($this->offerid !== $v) {
            $this->offerid = $v;
            $this->modifiedColumns[OfferTableMap::COL_OFFERID] = true;
        }
    ...
    public function setProductid($v)
    {
        ...
        if ($this->productid !== $v) {
            $this->productid = $v;
            $this->modifiedColumns[OfferTableMap::COL_PRODUCTID] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[OfferTableMap::COL_USERID] = true;
        }
    ...
    public function setCompanyid($v)
    {
        ...
        if ($this->companyid !== $v) {
            $this->companyid = $v;
            $this->modifiedColumns[OfferTableMap::COL_COMPANYID] = true;
        }
    ...
    public function setStartdate($v)
    {
        ...
        if ($this->startdate !== null || $dt !== null) {
            if ($this->startdate === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->startdate->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[OfferTableMap::COL_STARTDATE] = true;
            }
    ...
    public function setEnddate($v)
    {
        ...
        if ($this->enddate !== null || $dt !== null) {
            if ($this->enddate === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->enddate->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[OfferTableMap::COL_ENDDATE] = true;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [quanitity] column.
     *
     * @param int $v new value
     * @return $this|\Offer The current object (for fluent API support)
     */
    public function setQuanitity($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->quanitity !== $v) {
            $this->quanitity = $v;
            $this->modifiedColumns[OfferTableMap::COL_QUANITITY] = true;
        }
    ...
    public function setDiscount($v)
    {
        ...
        if ($this->discount !== $v) {
            $this->discount = $v;
            $this->modifiedColumns[OfferTableMap::COL_DISCOUNT] = true;
        }
    ...
    public function setDelted($v)
    {
        ...
        if ($this->delted !== $v) {
            $this->delted = $v;
            $this->modifiedColumns[OfferTableMap::COL_DELTED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OfferTableMap::translateFieldName('Offerid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OfferTableMap::translateFieldName('Productid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->productid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OfferTableMap::translateFieldName('Userid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OfferTableMap::translateFieldName('Companyid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->companyid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : OfferTableMap::translateFieldName('Startdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->startdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : OfferTableMap::translateFieldName('Enddate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->enddate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : OfferTableMap::translateFieldName('Quanitity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quanitity = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : OfferTableMap::translateFieldName('Discount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : OfferTableMap::translateFieldName('Delted', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 11; // 11 = OfferTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OfferTableMap::COL_OFFERID)) {
        ...
        if ($this->isColumnModified(OfferTableMap::COL_PRODUCTID)) {
            $modifiedColumns[':p' . $index++]  = 'ProductID';
        }
        if ($this->isColumnModified(OfferTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'UserID';
        }
        if ($this->isColumnModified(OfferTableMap::COL_COMPANYID)) {
            $modifiedColumns[':p' . $index++]  = 'CompanyID';
        }
        if ($this->isColumnModified(OfferTableMap::COL_STARTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'StartDate';
        }
        if ($this->isColumnModified(OfferTableMap::COL_ENDDATE)) {
            $modifiedColumns[':p' . $index++]  = 'EndDate';
        }
        if ($this->isColumnModified(OfferTableMap::COL_QUANITITY)) {
            $modifiedColumns[':p' . $index++]  = 'Quanitity';
        }
        if ($this->isColumnModified(OfferTableMap::COL_DISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'Discount';
        }
        if ($this->isColumnModified(OfferTableMap::COL_DELTED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'EndDate':
                        ...
                        break;
                    case 'Quanitity':
                        $stmt->bindValue($identifier, $this->quanitity, PDO::PARAM_INT);
                        break;
                    case 'Discount':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[8] => $this->getQuanitity(),
            $keys[9] => $this->getDiscount(),
            $keys[10] => $this->getDelted(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) {
            $this->setQuanitity($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setDiscount($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setDelted($arr[$keys[10]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OfferTableMap::COL_OFFERID)) {
            $criteria->add(OfferTableMap::COL_OFFERID, $this->offerid);
        }
        if ($this->isColumnModified(OfferTableMap::COL_NAME)) {
        ...
        if ($this->isColumnModified(OfferTableMap::COL_PRODUCTID)) {
            $criteria->add(OfferTableMap::COL_PRODUCTID, $this->productid);
        }
        if ($this->isColumnModified(OfferTableMap::COL_USERID)) {
            $criteria->add(OfferTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(OfferTableMap::COL_COMPANYID)) {
            $criteria->add(OfferTableMap::COL_COMPANYID, $this->companyid);
        }
        if ($this->isColumnModified(OfferTableMap::COL_STARTDATE)) {
            $criteria->add(OfferTableMap::COL_STARTDATE, $this->startdate);
        }
        if ($this->isColumnModified(OfferTableMap::COL_ENDDATE)) {
            $criteria->add(OfferTableMap::COL_ENDDATE, $this->enddate);
        }
        if ($this->isColumnModified(OfferTableMap::COL_QUANITITY)) {
            $criteria->add(OfferTableMap::COL_QUANITITY, $this->quanitity);
        }
        if ($this->isColumnModified(OfferTableMap::COL_DISCOUNT)) {
            $criteria->add(OfferTableMap::COL_DISCOUNT, $this->discount);
        }
        if ($this->isColumnModified(OfferTableMap::COL_DELTED)) {
            $criteria->add(OfferTableMap::COL_DELTED, $this->delted);
        }
    ...
    /**
     * Generic method to set the primary key (offerid column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setQuanitity($this->getQuanitity());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setOfferid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildOffer The current object (for fluent API support)
     */
    ...
    {
        if (null !== $this->aCompany) {
            $this->aCompany->removeOffer($this);
        }
        if (null !== $this->aProduct) {
            $this->aProduct->removeOffer($this);
        }
        if (null !== $this->aUser) {
            $this->aUser->removeOffer($this);
        }
        $this->offerid = null;
        $this->name = null;
