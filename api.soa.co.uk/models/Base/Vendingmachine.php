...
/**
 * Base class that represents a row from the 'vendingmachine' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Vendingmachine implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\VendingmachineTableMap';
    ...
    /**
     * Initializes internal state of Base\Vendingmachine object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Vendingmachine</code> instance.  If
     * <code>obj</code> is an instance of <code>Vendingmachine</code>, delegates to
     * <code>equals(Vendingmachine)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Vendingmachine The current object, for fluid interface
     */
     ...
     * @return $this|\Vendingmachine The current object (for fluent API support)
     */
    public function setVendingmachineid($v)
    {
        ...
        if ($this->vendingmachineid !== $v) {
            ...
            $this->modifiedColumns[VendingmachineTableMap::COL_VENDINGMACHINEID] = true;
        }
    ...
    public function setLocationid($v)
    {
        ...
        if ($this->locationid !== $v) {
            $this->locationid = $v;
            $this->modifiedColumns[VendingmachineTableMap::COL_LOCATIONID] = true;
        }
    ...
    public function setCompanyid($v)
    {
        ...
        if ($this->companyid !== $v) {
            $this->companyid = $v;
            $this->modifiedColumns[VendingmachineTableMap::COL_COMPANYID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[VendingmachineTableMap::COL_NAME] = true;
        }
    ...
    public function setDelted($v)
    {
        ...
        if ($this->delted !== $v) {
            $this->delted = $v;
            $this->modifiedColumns[VendingmachineTableMap::COL_DELTED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VendingmachineTableMap::translateFieldName('Vendingmachineid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vendingmachineid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VendingmachineTableMap::translateFieldName('Locationid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VendingmachineTableMap::translateFieldName('Companyid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->companyid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VendingmachineTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VendingmachineTableMap::translateFieldName('Delted', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = VendingmachineTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Vendingmachine'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildVendingmachineQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Vendingmachine::setDeleted()
     * @see Vendingmachine::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildVendingmachineQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VendingmachineTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VendingmachineTableMap::COL_VENDINGMACHINEID)) {
            $modifiedColumns[':p' . $index++]  = 'vendingmachineID';
        }
        if ($this->isColumnModified(VendingmachineTableMap::COL_LOCATIONID)) {
            $modifiedColumns[':p' . $index++]  = 'LocationID';
        }
        if ($this->isColumnModified(VendingmachineTableMap::COL_COMPANYID)) {
            $modifiedColumns[':p' . $index++]  = 'CompanyID';
        }
        if ($this->isColumnModified(VendingmachineTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'Name';
        }
        if ($this->isColumnModified(VendingmachineTableMap::COL_DELTED)) {
            $modifiedColumns[':p' . $index++]  = 'delted';
        }

        $sql = sprintf(
            'INSERT INTO vendingmachine (%s) VALUES (%s)',
    ...
    {
        $pos = VendingmachineTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Vendingmachine'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Vendingmachine'][$this->hashCode()] = true;
        $keys = VendingmachineTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getVendingmachineid(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setVendingmachineid($arr[$keys[0]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VendingmachineTableMap::COL_VENDINGMACHINEID)) {
            $criteria->add(VendingmachineTableMap::COL_VENDINGMACHINEID, $this->vendingmachineid);
        }
        if ($this->isColumnModified(VendingmachineTableMap::COL_LOCATIONID)) {
            $criteria->add(VendingmachineTableMap::COL_LOCATIONID, $this->locationid);
        }
        if ($this->isColumnModified(VendingmachineTableMap::COL_COMPANYID)) {
            $criteria->add(VendingmachineTableMap::COL_COMPANYID, $this->companyid);
        }
        if ($this->isColumnModified(VendingmachineTableMap::COL_NAME)) {
            $criteria->add(VendingmachineTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(VendingmachineTableMap::COL_DELTED)) {
            $criteria->add(VendingmachineTableMap::COL_DELTED, $this->delted);
        }
    ...
    {
        $criteria = ChildVendingmachineQuery::create();
        $criteria->add(VendingmachineTableMap::COL_VENDINGMACHINEID, $this->vendingmachineid);
    ...
    {
        $validPk = null !== $this->getVendingmachineid();
    ...
    /**
     * Generic method to set the primary key (vendingmachineid column).
     *
    ...
    {
        return null === $this->getVendingmachineid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Vendingmachine (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setVendingmachineid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Vendingmachine Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCompany(ConnectionInterface $con = null)
    {
        if ($this->aCompany === null && ($this->companyid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addVendingmachines($this);
             */
        }
    ...
    public function getLocation(ConnectionInterface $con = null)
    {
        if ($this->aLocation === null && ($this->locationid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLocation->addVendingmachines($this);
             */
        }
     ...
     * If this ChildVendingmachine is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildVendingmachine The current object (for fluent API support)
     */
    public function setItems(Collection $items, ConnectionInterface $con = null)
    {
        ...
        foreach ($itemsToDelete as $itemRemoved) {
            $itemRemoved->setVendingmachine(null);
        }
     ...
     * Otherwise if this Vendingmachine is new, it will return
     * an empty collection; or if this Vendingmachine has previously
     * been saved, it will retrieve related Items from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Vendingmachine.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildItem[] List of ChildItem objects
     */
    public function getItemsJoinProduct(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildItemQuery::create(null, $criteria);
    ...
    public function setStocks(Collection $stocks, ConnectionInterface $con = null)
    {
        ...
        foreach ($stocksToDelete as $stockRemoved) {
            $stockRemoved->setVendingmachine(null);
        }
    ...
    {
        if (null !== $this->aCompany) {
            $this->aCompany->removeVendingmachine($this);
        }
        if (null !== $this->aLocation) {
            $this->aLocation->removeVendingmachine($this);
        }
    ...
    {
        return (string) $this->exportTo(VendingmachineTableMap::DEFAULT_STRING_FORMAT);
    }
