...
abstract class Permission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PermissionTableMap';
    ...
    /**
     * Initializes internal state of Base\Permission object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Permission The current object (for fluent API support)
     */
    public function setPermissionid($v)
    {
        ...
        if ($this->permissionid !== $v) {
            $this->permissionid = $v;
            $this->modifiedColumns[PermissionTableMap::COL_PERMISSIONID] = true;
        }
    ...
    public function setAdmin($v)
    {
        ...
        if ($this->admin !== $v) {
            $this->admin = $v;
            $this->modifiedColumns[PermissionTableMap::COL_ADMIN] = true;
        }
    ...
    public function setDelted($v)
    {
        ...
        if ($this->delted !== $v) {
            $this->delted = $v;
            $this->modifiedColumns[PermissionTableMap::COL_DELTED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PermissionTableMap::translateFieldName('Admin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->admin = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PermissionTableMap::translateFieldName('Delted', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = PermissionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Permission'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PermissionTableMap::COL_PERMISSIONID)) {
            $modifiedColumns[':p' . $index++]  = 'PermissionID';
        }
        if ($this->isColumnModified(PermissionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'Name';
        }
        if ($this->isColumnModified(PermissionTableMap::COL_ADMIN)) {
            $modifiedColumns[':p' . $index++]  = 'Admin';
        }
        if ($this->isColumnModified(PermissionTableMap::COL_DELTED)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getName(),
            $keys[2] => $this->getAdmin(),
            $keys[3] => $this->getDelted(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setAdmin($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setDelted($arr[$keys[3]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PermissionTableMap::COL_PERMISSIONID)) {
            $criteria->add(PermissionTableMap::COL_PERMISSIONID, $this->permissionid);
        }
        if ($this->isColumnModified(PermissionTableMap::COL_NAME)) {
            $criteria->add(PermissionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(PermissionTableMap::COL_ADMIN)) {
            $criteria->add(PermissionTableMap::COL_ADMIN, $this->admin);
        }
        if ($this->isColumnModified(PermissionTableMap::COL_DELTED)) {
            $criteria->add(PermissionTableMap::COL_DELTED, $this->delted);
        }
    ...
    /**
     * Generic method to set the primary key (permissionid column).
     *
    ...
    public function setUsers(Collection $users, ConnectionInterface $con = null)
    {
        ...
        foreach ($usersToDelete as $userRemoved) {
            $userRemoved->setPermission(null);
        }
     ...
     * @return ObjectCollection|ChildUser[] List of ChildUser objects
     */
    public function getUsersJoinGender(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserQuery::create(null, $criteria);
        $query->joinWith('Gender', $joinBehavior);
