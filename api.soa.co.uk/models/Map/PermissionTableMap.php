...
class PermissionTableMap extends TableMap
{
     ...
     */
    const COL_PERMISSIONID = 'permission.PermissionID';
     ...
     */
    const COL_ADMIN = 'permission.Admin';

    /**
     * the column name for the delted field
     */
    const COL_DELTED = 'permission.delted';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Permissionid', 'Name', 'Admin', 'Delted', ),
        self::TYPE_CAMELNAME     => array('permissionid', 'name', 'admin', 'delted', ),
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_PERMISSIONID, PermissionTableMap::COL_NAME, PermissionTableMap::COL_ADMIN, PermissionTableMap::COL_DELTED, ),
        self::TYPE_FIELDNAME     => array('PermissionID', 'Name', 'Admin', 'delted', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Permissionid' => 0, 'Name' => 1, 'Admin' => 2, 'Delted' => 3, ),
        self::TYPE_CAMELNAME     => array('permissionid' => 0, 'name' => 1, 'admin' => 2, 'delted' => 3, ),
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_PERMISSIONID => 0, PermissionTableMap::COL_NAME => 1, PermissionTableMap::COL_ADMIN => 2, PermissionTableMap::COL_DELTED => 3, ),
        self::TYPE_FIELDNAME     => array('PermissionID' => 0, 'Name' => 1, 'Admin' => 2, 'delted' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('PermissionID', 'Permissionid', 'INTEGER', true, null, null);
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Permissionid', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Permissionid', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PermissionTableMap::COL_PERMISSIONID);
            $criteria->addSelectColumn(PermissionTableMap::COL_NAME);
            $criteria->addSelectColumn(PermissionTableMap::COL_ADMIN);
            $criteria->addSelectColumn(PermissionTableMap::COL_DELTED);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PermissionTableMap::COL_PERMISSIONID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PermissionTableMap::COL_PERMISSIONID) && $criteria->keyContainsValue(PermissionTableMap::COL_PERMISSIONID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.PermissionTableMap::COL_PERMISSIONID.')');
        }
